...
> به‌روزرسانی ۲۱ سپتامبر ۲۰۲۶: چهار محصول پایلوت از مقصد حذف شده‌اند و کاتالوگ مقصد خالی است. نسخه `0.2.0` مسیر ورود کامل و قابل‌ازسرگیری همه کالاهای فعال محک، نخستین تصویر هر کالا و دسته نگهدارنده موقت را اضافه می‌کند. اجرای واقعی این مسیر هنوز نیازمند بررسی dry-run روی سرور است.
...
## نتیجه پایلوت چهار کالا

| Mahak ProductDetail | Mixin Product | Mixin Image | دسته‌بندی |
|---:|---:|---:|---|
| 11629315 | 223 | 248 | مراقبت پوست (`6`) |
| 11629316 | 224 | 249 | دهان و دندان (`21`) |
| 11629317 | 225 | 250 | دهان و دندان (`21`) |
| 11629318 | 226 | 251 | محصولات جنسی (`24`) |
