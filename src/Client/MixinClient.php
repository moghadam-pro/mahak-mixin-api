...
final class MixinClient
{
    ...
    public function createProductImage(array $image): array { return $this->request('POST', '/api/v4/product-images/', $image); }
    public function deleteProductImage(int $id): array { return $this->request('DELETE', "/api/v4/product-images/{$id}/"); }
    /** @param array<string, scalar|null> $query */
